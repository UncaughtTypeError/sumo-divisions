...
- **Card/Grid View Toggle**: Switch the Banzuke roster between a card layout and a compact grid table pairing East/West by rank; the day filter and rank sort apply to either layout, while win-count sorting is unavailable in grid view since it isn't meaningful for a rank-paired table; your choice is remembered between visits
